...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center editorial-grid bg-black overflow-hidden pt-10 md:pt-0">
        {heroImg && (
          <Image 
        ...
        <div className="relative z-10 flex flex-col justify-center w-full py-20 space-y-12 md:space-y-16">
          <div className="pt-12 md:pt-0">
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] font-black text-white leading-[0.85] tracking-tighter uppercase drop-shadow-2xl">
              Seikh <br />
              <span className="text-secondary italic font-normal ml-8 sm:ml-12 md:ml-20">Akhinoor Jyoti.</span>
            </h1>
          </div>
